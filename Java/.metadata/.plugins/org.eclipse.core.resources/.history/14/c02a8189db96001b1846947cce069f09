...
public class ExemploPara {
	...
	public static void main(String[] args) {
		...
		for (int x = 1; x <= HABITANTES; x++) {
			System.out.println("Informe o salário do Habitante " + x + ": R$");
		...
		System.out.printf("\nMédia salarios: R$ %.2f", mediaSalarios);
		System.out.printf("\nTotal de pessoas que ganham até R$ 100 é de %.2f%%", percentualPessoasSalarioAte100);
